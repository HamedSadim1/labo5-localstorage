...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  accent:
    "bg-linear-to-r from-rose-600 to-pink-600 text-white shadow-lg shadow-rose-500/30 hover:from-rose-700 hover:to-pink-700",
  ghost:
    "text-zinc-600 hover:text-orange-700 dark:text-zinc-400 dark:hover:text-orange-400",
